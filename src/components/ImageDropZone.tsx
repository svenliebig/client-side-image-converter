...
export const ImageDropZone: React.FC<Props> = ({ onImagesAccepted }) => {
    ...
    >
      {isError ? (
        ...
        <div className="text-center text-gray-500 dark:text-gray-400">
          <p className="text-lg">{t("dropzone.drop-multiple")}</p>
          <p className="text-sm">
            <Enumeration
              array={SUPPORTED_IMAGES.map((i) => i.name)}
              type="disjunction"
            />
          </p>
        </div>
